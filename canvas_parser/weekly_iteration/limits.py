...
MAX_PAGINATION_PAGES = int(os.getenv('CANVAS_MAX_PAGINATION_PAGES', '50'))
MAX_PAGINATION_ITEMS = int(os.getenv('CANVAS_MAX_PAGINATION_ITEMS', '5000'))
PER_PAGE = int(os.getenv('CANVAS_PER_PAGE', '100'))

# Page-body enrichment (one API call per module page).
MAX_PAGE_BODY_FETCHES = int(os.getenv('CANVAS_MAX_PAGE_BODY_FETCHES', '250'))
